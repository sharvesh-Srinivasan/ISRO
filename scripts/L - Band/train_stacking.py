...
def map_backscatter_to_label(backscatter):
    ...
    """
    if backscatter <= 10.142:
        return 0  # Water
    elif 10.142 < backscatter <= 19.638:
        return 1  # Land
    elif 19.638 < backscatter <= 20.818:
        return 2  # Crop land
    else:
        return 3  # Mountain
...
def main():
    ...
    for i in range(max_images):
        ...
        # Calculate overall mean db value
    ...
    print('\n==================================')
    print('Final Stacking Model Performance (Test Set)')
